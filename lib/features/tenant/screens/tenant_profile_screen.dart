        ...
        children: [
          ...
          _ProfileCard(
            children: [
              ...
              const Divider(),
              _ProfileRow(icon: Icons.location_on_outlined, label: 'County', value: user?.county ?? 'Not set'),
              const Divider(),
              _ProfileRow(icon: Icons.badge_outlined, label: 'Status', value: (user?.status ?? '').toUpperCase()),
              const Divider(),
              _ProfileRow(icon: Icons.subscriptions_outlined, label: 'Plan', value: (user?.subscriptionTier ?? 'free').toUpperCase()),
            ],
          ),
          ...
          const SizedBox(height: 16),
          if (user?.subscriptionTier == 'free') const PremiumBanner(),
          const SizedBox(height: 16),
          _ProfileCard(
            children: [
