      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const OwnerEditProfileScreen())),
          ),
        ],
      ),
      body: userAsync.when(
        ...
        children: [
          ...
          CircleAvatar(
            ...
            child: Text(
              ...
              style: const TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: AppColors.warning),
            ),
          ),
          ...
          Card(
            ...
            child: Column(
              children: [
                ...
                const Divider(),
                _Row(icon: Icons.business_outlined, label: 'Company', value: user?.companyName ?? 'Not set'),
                const Divider(),
                _Row(icon: Icons.badge_outlined, label: 'Business Reg', value: user?.businessRegistration ?? 'Not set'),
                const Divider(),
                _Row(icon: Icons.subscriptions_outlined, label: 'Plan', value: (user?.subscriptionTier ?? 'free').toUpperCase()),
